      ...
      setInfo((prevInfo) =>
        prevInfo.map((question) => {
          if (question.id === questionId) {
            return { ...question, content: questionContent, answers: selectedQuestion.answers.map((item) => ({
              content: item.content,
              status: item.status,
            }))};
          } else {
                  ...
                  <div className="modal-body">
                    ...
                    <div className="form-group">
                      ...
                      <select
                        ...
                        //       status: selectedQuestion.answers.status.map((item) => {
                      ...
                      >
                        {selectedQuestion.answers.map((answer, index) => (
                          <option value={answer.status} key={index}>{answer.content}</option>
                        ))}
                      </select>
                    </div>
                  </div>
