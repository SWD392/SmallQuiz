...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                .authorizeRequests().antMatchers("/api/excel/upload","/authenticate", "/register","/generateDatabase","/test","/admin","/info","/role","/loadTest","/admin/create_question", "/admin/update_question").permitAll()
